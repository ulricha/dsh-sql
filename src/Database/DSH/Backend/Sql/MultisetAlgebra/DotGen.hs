-- | Debugging utility for multiset algebra plans. Takes a plan from the command
...
import           Database.DSH.Backend.Sql.MultisetAlgebra.Dot
...
main = do
    ...
    let dot = renderMADot rs (nodeMap dag)
